...
-- Last modification date: 2025-02-28 14:17:18.735
...
-- Table: restaurant_service
CREATE TABLE restaurant_service (
    id int  NOT NULL,
    restaurant_id int  NOT NULL,
    service_id int  NOT NULL,
    CONSTRAINT restaurant_service_pk PRIMARY KEY (id)
);
...
-- Reference: restaurant_service_restaurant (table: restaurant_service)
ALTER TABLE restaurant_service ADD CONSTRAINT restaurant_service_restaurant
    FOREIGN KEY (restaurant_id)
    REFERENCES restaurant (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: restaurant_service_service (table: restaurant_service)
ALTER TABLE restaurant_service ADD CONSTRAINT restaurant_service_service
